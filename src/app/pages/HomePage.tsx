...
const continueWatching = [
  { title: 'Dune: Part Two', detail: 'Runtime 2h 46m', progress: 74, accent: 'accent' as const },
  { title: 'Poor Things', detail: 'Runtime 2h 21m', progress: 42, accent: 'warning' as const },
  { title: 'Oppenheimer', detail: 'Runtime 3h 0m', progress: 91, accent: 'success' as const },
] as const;

const watchlist = [
  { title: 'The Batman', meta: 'Thriller, 2022', status: 'Queued for Friday night' },
  { title: 'Spider-Man: Across the Spider-Verse', meta: 'Animation, 2023', status: 'High priority' },
  { title: 'Arrival', meta: 'Sci-fi, 2016', status: 'Rewatch planned' },
] as const;
          ...
          <Card tone="glass" className="relative overflow-hidden">
            ...
            <div className="relative flex flex-col gap-6">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="text-sm text-muted">Public catalog, personal lists, and admin surfaces</span>
              </div>
              ...
              <div className="max-w-2xl space-y-4">
                ...
                <p className="max-w-xl text-base leading-7 text-muted">
                  A route-driven movie app with a public landing page, protected personal areas, and admin-only
                  management screens.
                </p>
              </div>
